<template>
<transition name="filter-tournaments">
<ion-app>
<ion-header>
  <ion-toolbar color="primary">
    <ion-title>
      <center>Filter Tournament List</center>
    </ion-title>
...
<ion-content padding class="verticalCenterContainer">
  ...
  <div class="verticalCenterContent">
    <div>
      ...
      <button @click="filter(filters.ALL)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">Show All</div></button>
      <button @click="filter(filters.FAVORITES)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0">
        <div class="mv2">
          <div class=""><ion-icon name="star-outline" style="font-size: 25px;"></ion-icon></div>
          <div class="">Favorites</div>
        </div>
      </button>
      <button @click="filter(filters.FOUR_HUNDRED)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">400 pts<br />(Major Zones)</div></button>
      <button @click="filter(filters.SIX_HUNDRED)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">600 points</div></button>
      <button @click="filter(filters.TWO_HUNDRED)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">200 points</div></button>
      <button @click="filter(filters.ONE_HUNDRED)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">100 points</div></button>
      <button @click="filter(filters.OTHER)" class="f6 link dim ba ph3 pv2 mb2 dib black bg-light-blue w-75 br3 b" href="#0"><div class="mv2">Other (?)</div></button>
